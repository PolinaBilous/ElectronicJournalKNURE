...
{
    public class GenerateClassRatingReport
    {
        // Creates a WordprocessingDocument.
        public void CreatePackage(string filePath, List<PupilWithAvgMark> pupils)
        {
            using (WordprocessingDocument package = WordprocessingDocument.Create(filePath, WordprocessingDocumentType.Document))
            {
                CreateParts(package, pupils);
            }
        }

        // Adds child parts and generates content of the specified part.
        private void CreateParts(WordprocessingDocument document, List<PupilWithAvgMark> pupils)
        {
            ExtendedFilePropertiesPart extendedFilePropertiesPart1 = document.AddNewPart<ExtendedFilePropertiesPart>("rId3");
            GenerateExtendedFilePropertiesPart1Content(extendedFilePropertiesPart1);

            MainDocumentPart mainDocumentPart1 = document.AddMainDocumentPart();
            GenerateMainDocumentPart1Content(mainDocumentPart1, pupils);
        ...
        private void GenerateExtendedFilePropertiesPart1Content(ExtendedFilePropertiesPart extendedFilePropertiesPart1)
        {
            ...
            charactersWithSpaces1.Text = "226";
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1, List<PupilWithAvgMark> pupils)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphAddition = "002955C8", RsidParagraphProperties = "00B26172", RsidRunAdditionDefault = "00B26172" };

            ParagraphProperties paragraphProperties1 = new ParagraphProperties();
            Indentation indentation1 = new Indentation() { Start = "1416" };
            ...
            Run run2 = new Run() { RsidRunProperties = "00B26172" };
            ...
            Text text2 = new Text();
            text2.Text = "Рейтинг учеников класса 1-А";
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphAddition = "00B26172", RsidParagraphProperties = "00B26172", RsidRunAdditionDefault = "00B26172" };
            ...
            Run run8 = new Run() { RsidRunAddition = "00421E5C" };
            ...
            {
                Paragraph paragraph3 = new Paragraph() { RsidParagraphAddition = "00B26172", RsidParagraphProperties = "00B26172", RsidRunAdditionDefault = "00B26172" };
                ...
                text6.Text = pupils[i].Surname + " " + pupils[i].Name + " " + pupils[i].Patronymic + new string(' ', 70 - (pupils[i].Surname.Length + pupils[i].Surname.Length + pupils[i].Patronymic.Length + 3));

                run10.Append(runProperties10);
                run10.Append(text6);

                Run run11 = new Run() { RsidRunAddition = "00421E5C" };
                ...
                text8.Text = pupils[i].AvgMark.ToString();
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "00B26172" };
            Rsid rsid1 = new Rsid() { Val = "002955C8" };
            Rsid rsid2 = new Rsid() { Val = "00421E5C" };
            Rsid rsid3 = new Rsid() { Val = "00B26172" };
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "71751419" };
            W15.ChartTrackingRefBased chartTrackingRefBased1 = new W15.ChartTrackingRefBased();
            W15.PersistentDocumentId persistentDocumentId1 = new W15.PersistentDocumentId() { Val = "{0F23A640-29EF-46D3-B374-C477B7B3CF13}" };
        ...
        private void SetPackageProperties(OpenXmlPackage document)
        {
            ...
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2017-11-20T08:55:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2017-11-20T09:05:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
