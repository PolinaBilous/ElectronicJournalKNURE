...
{
    public class GeneratePupilMarksReport
    {
        // Creates a WordprocessingDocument.
        public void CreatePackage(string filePath, PupilFullInformation pupil, List<Subject> subjects, List<List<Mark>> marks)
        {
            using (WordprocessingDocument package = WordprocessingDocument.Create(filePath, WordprocessingDocumentType.Document))
            {
                CreateParts(package, pupil, subjects, marks);
            }
        }

        // Adds child parts and generates content of the specified part.
        private void CreateParts(WordprocessingDocument document, PupilFullInformation pupil,List<Subject> subjects, List<List<Mark>> marks)
        {
            ExtendedFilePropertiesPart extendedFilePropertiesPart1 = document.AddNewPart<ExtendedFilePropertiesPart>("rId3");
            GenerateExtendedFilePropertiesPart1Content(extendedFilePropertiesPart1);

            MainDocumentPart mainDocumentPart1 = document.AddMainDocumentPart();
            GenerateMainDocumentPart1Content(mainDocumentPart1, pupil, subjects, marks);
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1, PupilFullInformation pupil, List<Subject> subjects, List<List<Mark>> marks)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphAddition = "003D54E8", RsidParagraphProperties = "005A0F3B", RsidRunAdditionDefault = "005A0F3B" };
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphMarkRevision = "005A0F3B", RsidParagraphAddition = "005A0F3B", RsidParagraphProperties = "005A0F3B", RsidRunAdditionDefault = "005A0F3B" };
            ...
            Run run2 = new Run() { RsidRunProperties = "005A0F3B" };
            ...
            Run run3 = new Run() { RsidRunProperties = "005A0F3B" };
            ...
            Text text3 = new Text();
            text3.Text = pupil.Surname + " " + pupil.Name + " " + pupil.Patronymic;
            ...
            Paragraph paragraph3 = new Paragraph() { RsidParagraphAddition = "005A0F3B", RsidParagraphProperties = "005A0F3B", RsidRunAdditionDefault = "005A0F3B" };
            ...
            Run run4 = new Run() { RsidRunProperties = "005A0F3B" };
            ...
            {
                Paragraph paragraph4 = new Paragraph() { RsidParagraphMarkRevision = "005A0F3B", RsidParagraphAddition = "005A0F3B", RsidParagraphProperties = "005A0F3B", RsidRunAdditionDefault = "005A0F3B" };
                ...
                Run run5 = new Run() { RsidRunProperties = "005A0F3B" };
                ...
                Text text5 = new Text();
                text5.Text = subjects[i].Subject_Name;

                run5.Append(runProperties5);
                run5.Append(text5);

                Run run6 = new Run() { RsidRunProperties = "005A0F3B" };
                ...
                runProperties6.Append(languages2);
                Text text6 = new Text();
                ...
                {
                    if (marks[i][j].PupilMark != null)
                        str.Append(marks[i][j].PupilMark.ToString() + " ");
                    else
                    {
                        str.Append("н ");
                    }
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "005A0F3B" };
            Rsid rsid1 = new Rsid() { Val = "003D54E8" };
            Rsid rsid2 = new Rsid() { Val = "005A0F3B" };
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "57B7A5B4" };
            W15.ChartTrackingRefBased chartTrackingRefBased1 = new W15.ChartTrackingRefBased();
            W15.PersistentDocumentId persistentDocumentId1 = new W15.PersistentDocumentId() { Val = "{6BB34429-6D4C-4434-8534-46E916D03808}" };
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            runPropertiesBaseStyle1.Append(fontSizeComplexScript15);
        ...
        private void SetPackageProperties(OpenXmlPackage document)
        {
            ...
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2017-11-20T11:25:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2017-11-20T11:29:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
